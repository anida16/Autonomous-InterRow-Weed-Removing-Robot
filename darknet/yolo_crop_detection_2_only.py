...
def cvDrawBoxes(detections, img):
    ...
    color_dict = {
        ...
        'hair drier' : [129, 12, 229],'toothbrush' : [11, 126, 158], 'test_crop' : [0, 255, 0]
    }
...
def YOLO():
    ...
    configPath = "/home/anish/Desktop/FinalYear Project (Files too big)/Strawberry_Yolo_v4/darknet/cfg/custom-yolov4-tiny-detector1.cfg"                                 # Path to cfg
    weightPath = "/home/anish/Desktop/FinalYear Project (Files too big)/Strawberry_Yolo_v4/darknet/custom-yolov4-tiny-detector_last.weights"                                 # Path to weights
    metaPath = "/home/anish/Desktop/FinalYear Project (Files too big)/Strawberry_Yolo_v4/darknet/cfg/obj_tiny1.data"                                    # Path to meta data
    ...
    cap = cv2.VideoCapture(2)                                      # Uncomment to use Webcam
