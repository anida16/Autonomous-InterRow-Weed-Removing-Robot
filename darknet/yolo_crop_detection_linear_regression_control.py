...
def YOLO():
    ...
    while True:                                                      # Load the input frame and write output frame.
        ...
        if ((X1.size is 0) or (X4.size is 0) or (X1.size is 1) or (X4.size is 1)) is True:
            print("No Crops found")
            writeData(0xB6)   
            ...
            #Motion Alog:
            '''
            if angle2 <= -82.5 and angle2 >= -87 and angle3 >= 82.5 and angle3 <= 87:
                print("forward")
                writeData(0x5B) #Steering Angle
                writeData(0x1A) #Speed

            elif angle2 <= -80 and angle2 >= -82.5 and angle3 >= 87 and angle3 <= 90:
                print("clockwise")
                writeData(0x4C) #Steering Angle right
                writeData(0x1A) #Speed

            elif angle2 <= -87 and angle2 >= -90 and angle3 >= 80 and angle3 <= 82.5:
                print("anticlockwise")
                writeData(0x6B) #Steering Angle left
                writeData(0x1A) #Speed
            '''
            '''
            if angle1 <= -70 and angle1 >= -78 and angle4 >= 70 and angle4 <= 78:
                print("forward")
                writeData(0x5B) #Steering Angle
                writeData(0x1A) #Speed

            elif angle1 <= -78 and angle1 >= -85 and angle4 >= 64 and angle4 <= 70:
                print("clockwise") #big error
                writeData(0x4C) #Steering Angle right
                writeData(0x1A) #Speed

            elif angle1 <= -64 and angle1 >= -70 and angle4 >= 78 and angle4 <= 85:
                print("anticlockwise") #big error
                writeData(0x6B) #Steering Angle left
                writeData(0x1A) #Speed
            '''

            '''
            elif angle1 <= -70 and angle1 >= -78 and angle4 >= 64 and angle4 <= 70:
                print("clockwise") #small error
                writeData(0x4C) #Steering Angle right
                writeData(0x1A) #Speed

            elif angle1 <= -64 and angle1 >= -70 and angle4 >= 70 and angle4 <= 78:
                print("anticlockwise") #small error
                writeData(0x6B) #Steering Angle left
                writeData(0x1A) #Speed

            elif angle1 <= -78 and angle1 >= -85 and angle4 >= 70 and angle4 <= 78:
                print("clockwise") #small error
                writeData(0x4C) #Steering Angle right
                writeData(0x1A) #Speed

            elif angle1 <= -70 and angle1 >= -78 and angle4 >= 78 and angle4 <= 85:
                print("anticlockwise") #small error
                writeData(0x6B) #Steering Angle left
                writeData(0x1A) #Speed
            ...
            if (angle1 + angle4) < 3 and (angle1 + angle4) > -3:
                #print("forward")
                writeData(0x5B) #Steering Angle
                writeData(0x37) #Speed

            elif ((angle1 + angle4) > 3 and (angle1 + angle4) < 30):
                #print("clockwise")
