...
cv2.createTrackbar('kp','Trackbar',50,1000,nothing)
cv2.createTrackbar('kd','Trackbar',640,1000,nothing)
...
def YOLO():
    ...
    Angle_error = 0 #Part of PID
    Sum_error = 0 #Part of PID
    Previous_Angle = 0 #Part of PID
    Steering_With_PID = rospy.Publisher('/Angle_Error', Float64, queue_size=1)
    ...
    while True:                                                      # Load the input frame and write output frame.
        ...
        if (((X1.size is 0) or (X4.size is 0) or (X1.size is 1) or (X4.size is 1)) and ((A1.size is 0) or (A4.size is 0) or (A1.size is 1) or (A4.size is 1))) is True:
            ...
            '''
            Kp = cv2.getTrackbarPos('kp','Trackbar')
            ...
            Angle_Error = angle1_C2 + angle4_C2
                
            Steering_With_PID = kp * Angle_Error + kd  * (Angle_error - Previous_Angle) + ki * Sum_error

            Sum_error = Sum_error + Angle_Error
            Previous_Angle_Error = Angle_Error

            print("PID",Steering_With_PID)
            ...
            writeData(0x2D) #Speed 


            Steering_to_Pid = ({
            (140, 1000): 0x3D,
            (138.343,140): 0x3E,
            (136.676,138.343): 0x3F,
            (135,136.676): 0x40,
            (133.342, 135): 0x41,
            (131.676,133.342): 0x42,
            (130,131.676): 0x43,
            (128.341, 130): 0x44,
            (126.674,128.341): 0x45,
            (125, 126.674): 0x46,
            (123.34, 125): 0x47,
            (121.673, 123.34): 0x48,
            (120, 121.67): 0x49,
            ...
            Steering_angle = 90 + Steering_With_PID        
            Steering_angle_1 = range_index1(Steering_to_Pid, Steering_angle)

            print(Steering_angle_1)
            writeData(Steering_angle_1) #steering 
